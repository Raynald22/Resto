...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 03, 2020 at 09:00 AM
...
INSERT INTO `pesanan` (`id`, `no_meja`, `id_produk`, `nama`, `jumlah`, `harga`, `gambar`, `status`) VALUES
(2, 1, 0, 'Rendang', 1, 15000, '', 'Ready'),
(4, 2, 0, 'Nasi Uduk', 1, 150000, '', 'Ready');
